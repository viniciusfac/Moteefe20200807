...
public class Supplier {
	...
	public static String getSupplier(String region, String product, Integer quantity) {
		...
		for (Map.Entry<Integer, List<String>> entry : Supplier.getSupplierMap().entrySet()) {
			...
			if (values.contains(product)) {
				...
				//TODO: verify if in_stock has mores or less product
				//Integer.parseInt(values.get(5)) >= quantity
            	...
            	System.out.println("DELIVERY_TIME:" + deliveryTime);
